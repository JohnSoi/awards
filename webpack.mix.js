...
mix
    ...
    .js('resources/js/page/news/show.js', 'js/page/news')
    ...
    .js('resources/js/page/nomination/show.js', 'js/page/nomination')
    ...
    .sass('resources/scss/page/about.scss', 'css/page')
    .sass('resources/scss/page/news/index.scss', 'css/page/news')
    .sass('resources/scss/page/news/show.scss', 'css/page/news')
    .sass('resources/scss/page/news/item.scss', 'css/page/news')
    ...
    .sass('resources/scss/page/nomination/index.scss', 'css/page/nomination')
