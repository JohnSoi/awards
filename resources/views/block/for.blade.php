<section class="section section-content section-for" id="about-award">
    ...
    <div class="container position-relative">
        ...
        <div class="section-for__title">
            <h2 class="section-title text-white mb-0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"
                data-wow-offset="30">
                R.C.AWARDS
            </h2>
        </div>
        <div class="section-for__inner">
            <div class="section-for__left">
                <div class="section-for__bigtitle text-white wow fadeInUp" data-wow-duration="0.8s"
                     data-wow-delay="0.2s" data-wow-offset="30">Для чего?
                </div>
            ...
            <div class="section-for__right">
                <div class="section-for__figure wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"
                     data-wow-offset="30">
        ...
        <div class="section-for__columns">
            <div class="section-for__animated">
                <div class="section-for__animated-figure">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                         style="opacity: 0; visibility: hidden; position:absolute; bottom: 0; left: 0; z-index: -1;">
                        <defs>
                            <linearGradient id="violet_gradient" x1="0%" y1="0%" x2="0%" y2="100%"
            ...
            <div class="section-for__author">
                <div class="section-for__avatar wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s"
                     data-wow-offset="30">
                    <picture>
                ...
                <div class="section-for__quote">
                    <div class="section-for__quote-text text text-white wow fadeInUp" data-wow-duration="0.8s"
                         data-wow-delay="0.2s" data-wow-offset="30">
                        «Мне очень нравится идея, которая родилась на&nbsp;Российской креативной неделе, о&nbsp;том,
                        чтобы сделать в&nbsp;следующем году первую российскую национальную премию за&nbsp;успехи и&nbsp;достижения
                        в&nbsp;креативных индустриях».
                    </div>
                    <div class="section-for__quote-name text-white wow fadeInUp" data-wow-duration="0.8s"
                         data-wow-delay="0.3s" data-wow-offset="30">
                        Сергей Кириенко
                    </div>
                    <div class="section-for__quote-devider devider devider-white wow fadeInUp" data-wow-duration="0.8s"
                         data-wow-delay="0.4s" data-wow-offset="30"></div>
                    <div class="section-for__quote-footer text-white wow fadeInUp" data-wow-duration="0.8s"
                         data-wow-delay="0.5s" data-wow-offset="30">
