    ...
    <div class="header-top">
        <div class="header-top__inner container" ajax-elem>
            ...
            <nav class="header-menu">
                ...
                <a href="{{ Route('index') }}#graphic" class="header-menu__link" style="display: none !important;" elem-hide>График проведения</a>
        ...
        <div class="menu-mob__inner container">
            <div class="menu-mob__nav">
                <nav class="menu-navigation">
                    ...
                    <a href="/files/Polozhenie_RCA.pdf" target="_blank" class="menu-navigation__link" style="display: none !important;" elem-hide burger-close>Положение</a>
                    <a href="{{ Route('index') }}#graphic" class="menu-navigation__link" style="display: none !important;" elem-hide burger-close>График проведения</a>
                    <a href="{{ Route('competition') }}" class="menu-navigation__link" burger-close>Конкурс</a>
                    <a href="{{ Route('index') }}#ceremony" class="menu-navigation__link" style="display: none !important;" elem-hide burger-close>Церемония</a>
