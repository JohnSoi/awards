...
@section('content')
    <section class="section section-content section-main">
        ...
        <svg fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
                <linearGradient id="gray-gradient" x1="184.619" y1="53.0393" x2="12.1039" y2="70.0247"
    ...
    <section class="section section-content section-cta new-main">
        <div class="container">
            <div class="section-cta__inner">
                <h2 style="margin-top: 30px;" class="section-center-title text-semipink mb-0 wow fadeIn"
                    data-wow-duration="0.8s" data-wow-delay="0.2s" data-wow-offset="0">Независимая <br>кросс-отраслевая
                    премия <br>в области креативных индустрий России
                </h2>
    ...
    <section class="section section-content section-themes black-block new-main">
        <div class="container section-themes__new wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s"
             data-wow-offset="0" id="award">
            <div class="border-top-white"></div>
            <h2 class="section-title mb-0 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s"
                data-wow-offset="0">
                R.C.AWARDS 2022
            </h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="video-iframe">
                        <iframe src="https://vk.com/video_ext.php?oid=-207545557&id=456239019&hash=c3a8f0f439fc7b1e&hd=1"
