...
<section class="section section-content section-cta new-main">
    <div class="container">
        <div class="section-cta__inner">
            <h2 class="section-center-title text-semipink mb-0 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s" data-wow-offset="0">{{__('main.main_tagline1')}} <br>{{__('main.main_tagline2')}} <br>{{__('main.main_tagline3')}}
            </h2>
