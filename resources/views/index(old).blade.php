...
<section class="section section-content section-main">
    ...
    <div class="postmark-position notanimated-marks container">
        <div class="postmark-area mt-md-n4 mt-sm-n4 mt-n3" style="z-index:0;">
            <div class="post-mark post-mark__green"></div>
            <div class="post-mark post-mark__emerland"></div>
        </div>
        <div class="postmark-area mt-md-n4 mt-sm-n4 mt-n3" style="z-index:5;">
            <div class="post-mark post-mark__violet"></div>
            <div class="post-mark post-mark__pink"></div>
            <div class="post-mark post-mark__darkred"></div>
        </div>
    </div>
                ...
                <div class="slide mt-md-n4 mt-sm-n4 mt-n3">
                    <div class="slide-content">
                        <div class=" slide__date">
                            <div class="slide__date-text">&nbsp;</div>
                            <div class="slide__date-place">&nbsp;</div>
                        </div>
                        <h1 class="slide__title">
                            <span class="font-weight-300">Russian</span><br>
                            <span class="font-weight-700">Creative<br>Awards</span><br>
                            <span class="font-weight-700">2021</span>
                        </h1>
                    </div>
                </div>
            </div>
...
<section class="section section-content section-cta new-main">
    <div class="container">
        <div class="section-cta__inner">
            <h2 class="section-center-title wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s" data-wow-offset="0">Независимая <br>кросс-отраслевая премия <br>в области креативных индустрий России
            </h2>
            <p class="section-center-text d-none">единственная кросc-отраслевая премия</p>
            <a href="#submit" class="btn btn-primary">Участвовать</a>
        </div>
    </div>
</section>
